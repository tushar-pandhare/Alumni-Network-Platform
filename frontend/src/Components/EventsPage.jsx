...
//               Discover webinars, meetups, and workshops hosted by alumni and
//               students.
//             </p>
//           </div>
//         </div>
...
//                 className="w-full pl-10 pr-4 py-2 rounded-xl border border-gray-300 bg-white text-gray-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
//               />
//             </div>
...
//               className="w-full md:w-48 py-2 px-4 border border-gray-300 bg-white text-gray-800 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
//             >
...
//                   viewport={{ once: true }}
//                   className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300 break-words"
//                 >
//                   {/* Header */}
//                   <div className="flex items-center gap-4 mb-4">
//                     <div className="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center">
//                       {typeIcons[event.type] || <FaCalendarAlt className="text-blue-600 text-xl" />}
//                     </div>
//                     <div>
...
//                       className="inline-block text-center bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg font-medium transition-colors duration-300"
//                     >
//                       🔗 Join Event
//                     </a>
//                   )}
